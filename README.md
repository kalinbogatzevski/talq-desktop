...
<sub>Stable codename: **July Morning** (the **0.56** milestone) — on the night of 30 June into 1 July, Bulgarians drive east to the Black Sea cliffs and stay awake to greet the first sunrise of the month together; a 1980s-counterculture ritual carried by Uriah Heep's 1971 song "July Morning," sung at the clifftop of Kamen Bryag. A name about renewal and a fresh start at first light — fitting for the line that finally makes **calls feel clean**: echo cancellation that works on **speakers** (no more hearing yourself), the **call-robustness wave** (signalling resume, hardware→software decode fallback, choppy-link recovery, live camera hotplug, consistent screen-share layout), **reliable startup**, and **robust software H.264 decoding** for any GPU. It follows **Bafana Bafana** (0.52, call & screen-share reliability) and **Slartibartfast** (0.50) on the *Hitchhiker's Guide* thread — *Deep Thought* (0.42) → *Magrathea* (0.44) → *Slartibartfast* — with **Botev** (0.48) / **Margaritka** (0.46) before that 🌅</sub>
