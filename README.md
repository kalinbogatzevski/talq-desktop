...
<sub>Stable codename: **Bafana Bafana** (the **0.52** milestone) — *"the boys,"* the nickname of South Africa's national football team, for the 2026 World Cup the country opens; a name about a team that holds together under pressure, which is what this line is: **call and screen-share reliability**. The 0.52 release caps it — reliable **app-window and re-share** screen sharing (no lost shares, no flicker-to-black), **instant one-to-one hangup**, **encoder-failure resilience** (a graphics-driver fault no longer drops the call), steadier video quality, and a hardened **Quit / auto-update / installer** path. It follows **Slartibartfast** (0.50) on the *Hitchhiker's Guide* thread — *Deep Thought* (0.42) → *Magrathea* (0.44) → *Slartibartfast* — and **Botev** (0.48) / **Margaritka** (0.46) and the 150th-anniversary cycle of Bulgaria's 1876 April Uprising before that ⚽🇿🇦</sub>
