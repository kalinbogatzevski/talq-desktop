...
OutputDir=..\dist
OutputBaseFilename=123NET-TalQ-v0.25.3-Setup
...
[Files]
Source: "..\dist\TalQ-v0.25.3-win64-123net\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Run]
Filename: "{app}\talq.exe"; Description: "Launch 123NET TalQ"; Flags: nowait postinstall
